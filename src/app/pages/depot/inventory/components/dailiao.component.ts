...
@Component({
    selector: 'depot-inventory-dailiao',
    templateUrl: './dailiao.html',
    styleUrls: ['./dailiao.scss']
})

export class DailiaoComponent {
    ...
    public columnDefs = [
        ...
        {
            headerName: '上次出货时间',
            field: 'last_delivery_time.date',
            width: 120,
        },
        {
            headerName: '上次出货数量',
            field: 'last_delivery_quantity',
            width: 120,
        }
    ];;
    ...
    private createRowData(page, key?: string) {
        this.listservice.getDailiaoList(page)
            .subscribe(data => {
                this.paginate = data;
