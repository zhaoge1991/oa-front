...
export class ListComponent{
  ...
  constructor(
    ...
    this.actionConfig.openUrl = 'pages/procurement/order/detail';
    this.actionConfig.idName = 'order_id';
    this.actionConfig.annex = true;
    this.actionConfig.noback = true;
    this.actionConfig.procurementCheck = true;
    this.actionConfig.isprocurmentOrder = true;
  }

  //行配置项(获取数据)
  private createRowData(page,key?:string) {
    this.listservice.getProcurementList(page,key)
      .subscribe(data=>{
  ...
  onCellDoubleClicked($event){
    this.router.navigate(['pages/procurement/order/detail',$event.data.order_id])
  }
