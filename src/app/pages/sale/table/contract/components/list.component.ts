...
export class ListComponent{
  ...
  public rowData: TableContract[];
  private columnDefs:any[];
  private selectedeRow: boolean;
  public selectedcolumnDefs: any[];
  public selectedrowData: TableContract;
  ...
  constructor(
    ...
    private listservice: ContractService,
    ...
    this.actionConfig.addNewUrl = 'pages/sale/table/contract/edit';
    this.actionConfig.deleteUrl = '/api/sale/table/contract/';
    this.actionConfig.openUrl = 'pages/sale/table/contract/detail';
    this.actionConfig.idName = 'id';
    this.actionConfig.editUrl = 'pages/sale/table/contract/edit';
    this.actionConfig.canEexport = {pdf:true};
    this.actionConfig.noback = true;
    this.actionConfig.exportOrder = true;
  }
  ...
  private createRowData(page,key?:string) {
    this.listservice.getlist(page,key)
      .subscribe(data=>{
        this.paginate = data.results.data.contracts;
  ...
  private onRowSelected($event) {
    if($event.node.selected){
      this.selectedrowData = $event.node.data as TableContract;
  ...
  onCellDoubleClicked($event){
    this.router.navigate(['pages/sale/table/contract/detail/',$event.data.id])
  }
