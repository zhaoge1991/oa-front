...
export class DetailComponent implements OnInit,OnDestroy{
  constructor(
    ...
    this.commonActionBarConfig.addNewUrl = 'pages/sale/table/contract/edit';
    this.commonActionBarConfig.editUrl = 'pages/sale/table/contract/edit';
    this.commonActionBarConfig.canEexport = {pdf:true};
    this.commonActionBarConfig.exportContract = true;
  }
