...
export class EditComponent implements OnInit{
  ...
  constructor(
    ...
    this.commonActionBarConfig.saveUrl = 'pages/sale/table/demand/edit';
  ...
  setData(){
    if(this.id){
      this.orderservice.get(this.id).subscribe(data=>{
        ...
        this.data = new TableDemand(data);
      ...
      let date = new Date();
      this.data = new TableDemand(null);
