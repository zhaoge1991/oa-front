...
import {TableDemand} from "../../../../../models/sale/table/TableDemand";
...
export class ListComponent{
  ...
  constructor(
    ...
    private listservice: DemandService,
    ...
    this.actionConfig.addNewUrl = 'pages/sale/table/demand/edit';
    this.actionConfig.deleteUrl = '/api/sale/table/demand/';
    this.actionConfig.openUrl = 'pages/sale/table/demand/detail';
    this.actionConfig.idName = 'id';
    this.actionConfig.editUrl = 'pages/sale/table/demand/edit';
    this.actionConfig.canEexport = {excel:true};
  ...
  private createRowData(page,key?:string) {
    this.listservice.getlist(page,key)
      .subscribe(data=>{
        this.paginate = data.results.data.demands;
  ...
  private onRowSelected($event) {
    if($event.node.selected){
      this.selectedrowData = $event.node.data as TableDemand;
  ...
  onCellDoubleClicked($event){
    this.router.navigate(['pages/sale/table/demand/detail/',$event.data.id])
  }
