...
export class ListComponent{
  ...
  constructor(
    ...
    this.actionConfig.openUrl = 'pages/finance/balance_payment/detail';
    this.actionConfig.idName = 'order_id';
    this.actionConfig.annex = true;
    this.actionConfig.noback = true;
    this.actionConfig.isFinance = 'payment';
  }
  ...
  onCellDoubleClicked($event){
    this.router.navigate(['pages/finance/balance_payment/detail',$event.data.order_id])
  }
