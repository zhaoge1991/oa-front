...
export class ListComponent{
  ...
  constructor(
    ...
    this.actionConfig.openUrl = 'pages/finance/order/detail';
    this.actionConfig.idName = 'order_id';
    this.actionConfig.annex = true;
    this.actionConfig.noback = true;
    this.actionConfig.financeCheck = true;
  }

  //行配置项(获取数据)
  private createRowData(page,key?:string) {
    this.listservice.getFinanceList(page,key)
      .subscribe(data=>{
  ...
  onCellDoubleClicked($event){
    this.router.navigate(['pages/finance/order/detail',$event.data.order_id])
  }
