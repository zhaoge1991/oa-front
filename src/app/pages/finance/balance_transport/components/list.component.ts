...
export class ListComponent{
  ...
  constructor(
    ...
    this.actionConfig.openUrl = 'pages/finance/balance_transport/detail';
    this.actionConfig.idName = 'order_id';
    this.actionConfig.annex = true;
    this.actionConfig.noback = true;
    this.actionConfig.isFinance = 'transport';
  }
  ...
  onCellDoubleClicked($event){
    this.router.navigate(['pages/finance/balance_transport/detail',$event.data.order_id])
  }
